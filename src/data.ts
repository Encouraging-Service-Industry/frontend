    ...
    clientReviews: [
      {
        ...
        rating: 5,
        comment:
          "Johanna did an outstanding job! My home has never been cleaner. Highly recommend her deep cleaning service.",
      ...
      }, // Reverted to English
      {
        ...
        reviewerName: "Mika",
        rating: 5,
        comment: "Punctual, professional, and very thorough. Johanna is a gem!",
    ...
    clientReviews: [
      {
        ...
        rating: 4,
        comment:
          "Mikko was good, arrived on time and did a solid job. Will book again.",
    ...
    clientReviews: [
      {
        ...
        rating: 5,
        comment:
          "Leo fixed my fridge in no time! Very knowledgeable and friendly.",
      ...
      }, // Reverted to English
      {
        ...
        rating: 4,
        comment:
          "Good service, a bit pricey but worth it for the quick repair.",
