...
const products = [
  { id: "course", name: "Online Course Voucher", price: 50, description: "Access an online course of your choice.", category: "Self-Investment" },
  { id: "gym", name: "Gym 1-Month Pass", price: 80, description: "One month gym membership.", category: "Health & Wellness" },
  { id: "movie", name: "Family Movie Tickets", price: 60, description: "Two tickets for a family movie night.", category: "Relationships" },
  { id: "cleaning", name: "20% Off Next Cleaning", price: 25, description: "Discount on your next cleaning service.", category: "Service Discounts" },
];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {filtered.map((p) => (
          <div key={p.id} className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
            <div className="h-28 bg-gray-50 rounded mb-3 flex items-center justify-center">
